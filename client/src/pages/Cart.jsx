...
const Cart = () => {
    ...
    const { products, currency, getCartCount, removeFromCart, updateCartItem, cartItems, navigate, getCartAmount } = useAppContext();


    const [cartArray, setCartArray] = useState([])
    const [address, setAddress] = useState(dummyAddress)
    const [selectedAdress, setSelectedAddress] = useState(dummyAddress[0]);
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        <p className="text-gray-500">{selectedAdress ? `${selectedAdress.street},${selectedAdress.city},${selectedAdress.state},${selectedAdress.country}` : 'No address found'}</p>
                        ...
                        {showAddress && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                                {address.map((adress, index) => (
                                    <p key={index} onClick={() => { setSelectedAddress(adress); setShowAddress(false) }}
